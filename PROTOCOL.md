...
The Shared Secret Salt is like a password and is bound to only one specific client RSA Public Key.
Further details on the key files will be described in the [KEYS.md](./KEYS.md) file.
